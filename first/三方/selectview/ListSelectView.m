...
- (void)initSelectView {
    ...
    self.selectView = [[UIView alloc]initWithFrame:CGRectMake(30, (PanScreenHeight-(self.collectionViewHeight+101))/2-80, SCREEN_WIDTH-60, self.collectionViewHeight+kSingleTitleHeight+kSingleBtnHeight+1)];
